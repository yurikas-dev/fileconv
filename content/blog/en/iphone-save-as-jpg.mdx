...
### If I switch to JPG, do my existing HEIC photos get deleted?

No. Switching to "Most Compatible" only affects photos taken after the change. All previously saved HEIC files remain untouched on your iPhone. To convert existing HEIC photos to JPG, use FileConv's batch conversion feature.

### Do I need to convert photos before sending via iMessage or WhatsApp?

No. Most messaging apps automatically convert photos to a compatible format during sending. However, if you send a photo **as a file attachment** (rather than as a photo), the recipient may receive the original HEIC file — which might not open on their device. When sharing as a file, convert to JPG first to be safe.

### Does changing the camera format also affect video?

Yes. When set to "Most Compatible," videos are recorded in H.264 (MP4) instead of H.265 (HEVC). H.264 is more widely supported by Windows software and older editing apps. If you frequently edit videos on Windows, "Most Compatible" is the safer choice for video as well.

### What about Google Photos backups?

Google Photos handles HEIC natively — your photos back up and display correctly regardless of format. If you only view photos through Google Photos or on your iPhone, there's no need to change the camera format. The format change is most useful when you frequently move files to a Windows PC or share with non-Apple users.

### Will switching to JPG affect how my photos look in apps like Mercari or eBay?

Most marketplace apps convert uploaded photos automatically, so HEIC usually works. However, conversion quality and behavior varies by app. For product listings where accurate colors and details matter, converting to JPG at high quality before uploading gives you the most control over the final result.
