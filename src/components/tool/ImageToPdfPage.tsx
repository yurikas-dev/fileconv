...
const jsonLd = {
  ...
  '@type': 'WebApplication',
  name: 'FileConv Image to PDF',
  description: 'Convert images to PDF for free — browser-only, no server upload',
...
export async function ImageToPdfPage() {
  const [t, tc, messages] = await Promise.all([
    getTranslations('imageToPdfHero'),
